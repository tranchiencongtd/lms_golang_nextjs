...
import { consultation } from '@/lib/api/consultation'
          ...
          <div className="bg-white rounded-2xl p-8 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className={`w-full py-4 bg-[#0056D2] text-white font-semibold rounded-xl text-base hover:bg-[#004BB5] transition-colors flex items-center justify-center gap-2 group ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
              >
                {isSubmitting ? (
                  <>
